...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-color: #e8f5e9; /* Светлый зеленый фон */
        }
        header {
        ...
        nav {
            background: #43a047; /* Яркий зеленый цвет */
            padding: 10px 0;
            text-align: center;
        }
        nav a {
...
<body>
    <header>
        <h1>Добро пожаловать на сайт нашего мероприятия!</h1>
    </header>
    <nav>
        <a href="READ.html">Главная</a>
        <a href="1.html">Информация</a>
        <a href="2.html">Контакты</a>
        <a href="3.html">Место проведения(<span id="cart-count">0</span>)</a>
    </nav>
    <section id="about">
        <h2> САЙТ ДЛЯ ДНЯ ПРОГРАММИСТА</h2>
        <p>бла-бла-бла</p>
    </section>
